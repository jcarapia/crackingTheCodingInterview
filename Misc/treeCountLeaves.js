...
Tree.prototype.countLeaves = function () {
  ...
  //check if the tree has children
    //if no children, the tree is the leaf itself, return 1
    //if children, iterate through the children and check each child
...
var grandparent = new Tree(1);
var parent1 = new Tree(2);
var parent2 = new Tree(3);
var parent3 = new Tree(4);
var child1 = new Tree(5);
var child2 = new Tree(6);
